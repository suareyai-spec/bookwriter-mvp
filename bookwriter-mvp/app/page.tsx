...
const CREATION_MODES = [
  ...
  },
  {
    title: "Comic & Theater",
    href: "/special",
    description: "Panel-by-panel comic scripts and full theatrical plays with stage directions, dialogue and scene structure — ready for collaborators and illustrators.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
