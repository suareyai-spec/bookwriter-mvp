...
export default function HandoffPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-dark">Shift Handoff</h1>
      ...
      {handoff?.handoff && (
        <div className="bg-white rounded-xl p-6 shadow-sm print:shadow-none">
          <div className="flex items-center justify-between mb-4 print:mb-2">
            <h2 className="text-lg font-semibold text-dark">SBAR Handoff Report — {handoff.patientCount} Patients</h2>
